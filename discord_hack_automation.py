...
def change_password(driver, old_pass, new_pass):
    ...
    # script creates an html request to change their password
...
def login_with_auth_token(driver, token):
    ...
    # because the default login field actually just makes a request to first generate the token, then use that token to login
